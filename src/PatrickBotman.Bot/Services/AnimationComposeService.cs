...
public class AnimationComposeService
{
    ...
    public async Task<InputOnlineFile> ComposeGifAsync(Gif gif, string text)
    {
        ...
        ProcessStartInfo processInfo = new ProcessStartInfo
        {
            ...
            CreateNoWindow = true,
            Arguments = isNewYear ? $"-i pipe: -i assets/snow.mov -f ismv  -filter_complex \"scale=350:-1,pad=ceil(iw/2)*2:ceil(ih/2)*2,overlay=shortest=1,{string.Join(',', new string[] { firstLineArgs, secondLineArgs })}\" pipe:"
